...
import { useImportCustomer } from "../../../utils/fetch/useCustomer";

function CustomerImportDataPage() {
  ...
  const { postData } = useImportCustomer();
  ...
  return (
    <>
      <div className="w-full p-4 bg-white">
        <p className="font-bold">Import Data Customer</p>
      </div>
      ...
      {showTablePreview ? (
        <div className="w-full p-4 bg-white  mt-4  ">
          ...
          <table className="w-full text-center mt-4">
            ...
            <tbody>
              {dataImportPreview.map((data, index) => {
                return (
                  <tr key={index}>
...
export default CustomerImportDataPage;
